...
const Features = () => {
  ...
  const features = [
      {
        ...
        desc: "Start receiving coffee (payments) in seconds - no complicated setup.",
  ...
  return (
    <section className='py-2 px-4 sm:px-8 bg-[#f5f1ee] text-center relative z-10 overflow-hidden'>
      ...
      {/* Description */}
      <p className='text-xs sm:text-lg text-gray-600 max-w-2xl mx-auto mb-16 sm:mb-20 px-8 sm:px-0'>We built Ek Cup Coffee to help creators grow, connect with fans, and earn without hassle. Here's what makes us special.</p>
