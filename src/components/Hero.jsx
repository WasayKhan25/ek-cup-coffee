...
//images of creaters
import maryamPic from "../assets/uppercards/maryamImg.jpg";
import broCodePic from "../assets/uppercards/BroCodeImg.jpg";
import hamzahPic from "../assets/uppercards/hamzahImg.jpg";
import junaidPic from "../assets/uppercards/junaidImg.jpg";
import sanaPic from "../assets/uppercards/sanaImg.jpg";
import hassanPic from "../assets/uppercards/hassanImg.jpg";

const testimonials = [
  {
    name: "Maryam is funding her art with Ek Cup Coffee",
    supporters: "2,200",
    avatar: maryamPic,
  },
  {
    name: "Bro Code shares coding tips & gets love through Coffee!",
    supporters: "4,800",
    avatar: broCodePic,
  },
  {
    name: "Hamzah writes poetry, powered by Coffee ☕",
    supporters: "700",
    avatar: hamzahPic,
  },
  {
    name: "Junaid is podcasting over sips of Coffee",
    supporters: "1,120",
    avatar: junaidPic,
  },
  {
    name: "Sana creates tutorials & Coffee fuels her",
    supporters: "3,450",
    avatar: sanaPic,
  },
  {
    name: "Hassan makes music & gets support via Coffee",
    supporters: "2,670",
    avatar: hassanPic,
  },
];
    ...
    <section className="relative w-full px-4 sm:px-8 text-center bg-[#f5f1ee] overflow-hidden pt-[100px] min-h-screen">
      ...
      <div className="relative z-50 flex flex-col justify-center items-center w-full max-w-3xl mx-auto px-2 sm:px-4 min-h-[calc(100vh-150px)]">
        ...
        <div className="flex flex-wrap justify-center items-center gap-1 text-sm font-medium text-chaiBrown mb-8 sm:mb-12">
          ...
          <span className="ml-2">Loved by 1,000,000+ Creators</span>
        </div>

        {/* Main heading */}
        <h1 className="text-5xl sm:text-5xl md:text-6xl font-extrabold text-black leading-tight mb-6 text-center">
          Fund your work. <br />
          <span className="logo-font text-chaiBrown">Keep going with a Coffee.</span>
        </h1>
        ...
        <p className="text-xs sm:text-sm text-gray-500 max-w-md lg:max-w-lg px-6 sm:px-12 mx-auto text-center leading-relaxed">
          Setting up your coffee shop takes less time than boiling water!
        </p>
      </div>
    </section>
  );
