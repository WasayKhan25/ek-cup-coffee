  ...
  const steps = [
    {
      ...
      desc: "Set up your profile with a photo, bio & set your coffee price.",
    ...
    },
    {
      ...
      desc: "Receive coffee (payments) and build a loyal supporter base.",
  ...
  return (
    <section className="py-8 px-4 sm:px-8 bg-[#f5f1ee] text-center relative z-10 overflow-hidden">
      ...
      <p className="text-xs sm:text-lg text-gray-600 max-w-2xl mx-auto mb-16 sm:mb-20 px-8 sm:px-0">
        Ek Cup Coffee makes supporting creators fun and effortless. In just a few
        taps, your fans can send coffee and show their appreciation.
      </p>
